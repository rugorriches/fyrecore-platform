  ...
  return (
    <section className="section"><div className="wrap">
      ...
      <dl className="ledger" style={{marginBottom:'2.5rem'}}>
        ...
        <div><dt>Spent on buybacks</dt><dd>{usd(t.buyback)}</dd></div>
      ...
      {hasData && (
        <div className="tblwrap"><table className="tbl">
          <thead><tr><th>Day</th><th>Revenue</th><th>Buyback</th><th>Prizes</th><th>Ops</th></tr></thead>
          <tbody>{daily.map(d => (
      ...
      <div className="head" style={{marginTop:'4rem'}}><h2>Seasons</h2>
        <p>Embers earned against Embers spent. A ratio at or above 1.0 means the economy drains at least as fast as it fills, which is the condition FYRE cannot launch without.</p></div>
      <div className="tblwrap"><table className="tbl">
      ...
      <div className="flow">
        ...
        <div className="flow__row flow__row--out"><span className="flow__key">30% buyback</span><p>Set aside to buy FYRE on the open market and send it to the rewards pool. This is what makes season rewards revenue-backed rather than printed.</p></div>
      ...
      <div className="note" style={{marginTop:'2.5rem'}}><p>Buybacks are rate-limited and capped per transaction in the contract, so a compromised operator key cannot drain the buyback balance through a single lossy swap.</p></div>
    </div></section>
  );
}