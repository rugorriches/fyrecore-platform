  ...
  return (
    <section className="section"><div className="wrap">
      ...
      <div className="pillars">
        <article className="pillar"><span className="pillar__tag">Core</span><h3>Your identity</h3><p>Sign in with an email; free play never needs a wallet. When you buy or compete for money you connect a wallet you control, and prize money is paid straight to it. We never hold your keys or your funds. Your rating, mastery, and cosmetics belong to the Core rather than to one title.</p></article>
        <article className="pillar"><span className="pillar__tag">Arena</span><h3>Brackets and prize pools</h3><p>Enter with nothing, with Embers, or with USDC. Pools are escrowed before the first match. If we go silent past the refund deadline, you reclaim your fee yourself.</p></article>
