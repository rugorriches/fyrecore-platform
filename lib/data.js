...
const FALLBACK_GAMES = [
  { slug:'ascension', name:'Ascension', genre:'Anime arena fighter', status:'alpha', section:'fyrecore', placement:'confirmed', engine:'Vite + Three.js',
    tagline:'Original anime arena fighter', lane:'open', accepted_currencies:['usdc','omenx','gmt'], featured:true, sort_order:1,
  ...
  { slug:'rift-runner', name:'Rift Runner', genre:'Arcade racer-shooter', status:'alpha', section:'fyrecore', placement:'tentative', engine:'WebGL',
    tagline:'Rail racer with extract-or-continue runs', lane:'both', accepted_currencies:['usdc','omenx','gmt'], sort_order:2,
    play_url:'https://rift-runner-rug-or-riches.vercel.app' },
  { slug:'warfront', name:'Warfront', genre:'Tactical war', status:'development', section:'fyrecore', placement:'confirmed', tagline:'Concept', lane:'open', accepted_currencies:['usdc'], sort_order:3 },
  { slug:'breachpoint', name:'Breachpoint', genre:'First-person shooter', status:'development', section:'fyrecore', placement:'confirmed', tagline:'Concept', lane:'open', accepted_currencies:['usdc'], sort_order:4 },
  { slug:'ashlands', name:'Ashlands', genre:'Open world', status:'development', section:'fyrecore', placement:'confirmed', tagline:'Concept', lane:'open', accepted_currencies:['usdc'], sort_order:5 },
...
const FALLBACK_COLLECTIONS = [
  { slug:'founders-pass', name:"VIP Pass", tier:'fyrecore', chain:'base', kind:'pass', supply_cap:11750, minted:0, status:'planned', sort_order:1,
    description:'Early access and cosmetics across every FyreCore title. Three tiers. No rewards, no revenue share.',
    perks:['Early access to all FyreCore titles','Exclusive cosmetics per title','Embers multiplier','VIP bracket seats'] },
