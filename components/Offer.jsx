...
const offer = [
  ...
  { k:'02', t:'One Core across every title',
    d:'A single identity carrying your rating, mastery and cosmetics. Sign in with an email to play; connect a wallet you control only when money is involved. Every new FyreCore game already knows how good you are.',
    a:['Email sign-in','Cross-game rating','Your keys, not ours'], href:'/platform', cta:'How it works' },
